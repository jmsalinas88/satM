...
public class SymptomListAdapter extends ArrayAdapter<Symptom> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Symptom symptom = new Symptom(getItem(position).getDescription(), getItem(position).getImage());
        LayoutInflater inflater = LayoutInflater.from(mContext);
        convertView = inflater.inflate(mResource, parent, false);
        ImageView imageViewSymptom = (ImageView)convertView.findViewById(R.id.imageViewSymptom);
        imageViewSymptom.setImageResource(symptom.getImage());
